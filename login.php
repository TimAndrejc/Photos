              ...
              <div class="card-body p-5" style=" padding:0;">
                <div class="my-md-5">
                  ...
                  <div class="form-outline form-white mb-4">
                    <input type="email" name="email" id="typeEmail" autocomplete="email" placeholder="Vnesi email" class="form-control form-control-lg active text-gray" />
                    <label class="form-label text-gray" for="typeEmail">Email</label>
                  </div>
                  <div class="form-outline form-white mb-4">
                    <input type="password" id="typePassword" placeholder="Vnesi geslo" name="password" class="form-control form-control-lg active text-gray" />
                    <label class="form-label text-gray" for="typePassword">Geslo</label>
                  </div>
                ...
                <div class="text-center">
                  ...
                  <p class="mb-0"><a href="login.php?forgotPassword=true" class="text-gray fw-bold">Forgotten password?</a></p>
                </div>
              </div>
            </div>
          </div>
